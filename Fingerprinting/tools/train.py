...
from Fingerprinting.dataset.sample import sliding_window, session_window
from Fingerprinting.tools.utils import (save_parameters, seed_everything,
                                 train_val_split)
...
class Trainer():
    def __init__(self, model, options):
        ...
        train_dataset = smarthome_dataset(self.data_dir,'Dataset-Ind-train-{}.pkl'.format(self.window_size))
        valid_dataset = smarthome_dataset(self.data_dir,'Dataset-Ind-valid-{}.pkl'.format(self.window_size))
        ...
        print('Find %d train samples, %d validation samples' %
